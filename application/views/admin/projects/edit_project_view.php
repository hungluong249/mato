            ...
            <div class="modified-mode">
                <div class="col-lg-10 col-lg-offset-0" style="margin-left: 15px;">
					...
					<div class="form-group">
                        ...
                        echo form_input('project_color', set_value('project_color', $project['project_color']), 'class="form-control"');
                        ?>
					</div>
                    <div class="form-group">
                        <?php
					...
					<div class="form-group">
                        ...
                        echo form_input('project_year', set_value('project_year', $project['project_year']), 'class="form-control"');
                        ?>
					</div>
                    <div class="form-group">
                        <?php
